...
<div class="admin">
	<div class="logo">
	<h1><a href="<%=cp %>/admin/movieList.do">MovieCube Administrator - Store Register</a></h1>
	</div>
				...
				<table>
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<input type="text" class="txt w200" id="STORE_ITEM" name="STORE_ITEM" value="${map.STORE_ITEM}" />
						...
						<tr>
							...
							<td>
								<input type="text" class="txt w200" id="STORE_PRICE" name="STORE_PRICE" value="${map.STORE_PRICE}" />
								<input type="hidden" id="STORE_NO" name="STORE_NO" value="${map.STORE_NO}" />
								<font color="red"></font>
							</td>
						</tr>	
						...
						<tr>
							...
							<td>
								<div class="textarea_grp">
									<textarea name="STORE_CONTENT">${map.STORE_CONTENT}</textarea>
								</div>
								<font color="red"></font>
							</td>
						</tr>
						...
						<tr>
							...
							<td>
								<input type="hidden" id="store" name="store" value="${map.FILE_NO}">
								<a href="#this" id="name" name="name"><font color="red">${map.IMAGE_ORGNAME}</font>&nbsp;&nbsp;&nbsp;</a>
...
<script type="text/javascript">
        ...
        function fn_insertBoard(){
            ...
            comSubmit.setUrl("<c:url value='storeModify.do' />");
            comSubmit.submit();
        }
