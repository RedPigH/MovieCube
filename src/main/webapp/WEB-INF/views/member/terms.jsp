	...
	<div class="container">
			...
			<dl>
				...
				<dd>
					...
					<ol>
						...
						<li>"휴면회원" : 메가박스 서비스를 이용한 마지막 날로부터 연속하여 12개월간 이용 내역이 없는 회원을 말합니다.</li>
					</ol>
				</dd>
		...
		<div class="p-t-15" tabindex="0" style="overflow-y:scroll; height:300px; padding:15px; border:1px solid">
			<dl>
				...
				메가박스중앙(주)는 최초 회원가입 시 개인정보의 수집항목 및 이용목적, 개인정보의 수집방법, 개인정보의 이용 및
				...
				<br>
				3. 개인정보의 이용·보관 기간<br>
				메가박스중앙(주)는 개인정보의 수집 및 제공 받은 목적이 달성되면 개인정보를 파기함을 원칙으로 합니다. 다만, 다음<br>
